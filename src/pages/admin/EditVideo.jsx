...
export default function EditVideo() {
  ...
  useEffect(() => {
    ...
    const loadContent = async () => {
      const contents = await getContentByType('videos')
      ...
      if (content) {
        setFormData({
          ...
          instagramEmbedUrl: content.instagramEmbedUrl || '',
          extra: content.extra || '',
        })
      }
      setLoading(false)
  ...
  const handleSubmit = async (e) => {
    ...
    const videoData = {
      ...formData,
      instagramPermalink: formData.instagramPermalink || undefined,
      instagramEmbedUrl: formData.instagramEmbedUrl || undefined,
    }

    const success = await updateContent('videos', id, videoData)
    if (success) {
